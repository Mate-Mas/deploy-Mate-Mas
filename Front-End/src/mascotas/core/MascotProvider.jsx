...
export function MascotProvider({
  children,
  defaultMascot = null, // Cambiado de 'multi' a null
  defaultState = 'idle',
  autoDismissMs = 5000,
}) {
  ...
  const value = useMemo(
    () => ({
      ...
      react,
      dismissMessage,
      clearMascot, // Exportamos la función para limpiar
    }),
    [mascotId, state, currentMessage, isSpeaking, setMascot, setState, say, react, dismissMessage, clearMascot],
  );
